    ...
    function(h) {
        h.extend(h.fn, {
            ...
            messages: {
                ...
                maxlength: h.validator.format("Lütfen {0} karakterden fazla girmeyin."),
                minlength: h.validator.format("Lütfen en az {0} karakter girin."),
                rangelength: h.validator.format("Lütfen {0} ile {1} karakter arasında bir değer girin."),
                range: h.validator.format("Lütfen {0} ve {1} arasında bir değer girin."),
                max: h.validator.format("Lütfen {0} değerine eşit veya daha küçük bir değer girin."),
                min: h.validator.format("Lütfen {0} değerine eşit veya daha büyük bir değer girin.")
            },
            autoCreateRanges: !1,
            prototype: {
                init: function() {
            ...
            addMethod: function(t, e, i) {
                h.validator.methods[t] = e, h.validator.messages[t] = void 0 !== i ? i : h.validator.messages[t], e.length < 7 && h.validator.addClassRules(t, h.validator.normalizeRule(t))
            },
            methods: {
