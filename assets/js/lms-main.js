V = {
  ...
  mobileMenu:function(){
    $(".mobile-menu").click(function() {
        ...
        $(".menuM").toggleClass("opened");
        $(".menuM .menu-item").toggleClass("menu-item-animated");
        $(".menuM .menu-item-alt").toggleClass("menu-itemAlt-animated");
        $(".menuM .catalog-link").toggleClass("catalog-link-animated");
    ...
    $( ".inner-links").click(function( event ) {
        event.preventDefault();
        if($(".mobile-menu").hasClass("active-cross")){
          $("body").removeClass("stop-scrolling");
          $("header").removeClass("menu-active");
          $(".mobile-menu").removeClass("active-cross");
          $(".menuM").removeClass("opened");
          $(".menuM .menu-item").removeClass("menu-item-animated");
          $(".menuM .menu-item-alt").removeClass("menu-itemAlt-animated");
          $(".menuM .catalog-link").removeClass("catalog-link-animated");
        }
  ...
  formFunc: function() {
      ...
      $(".contact, .contact-close, .close-success").click(function(){
        if($(".menuM.opened").length > 0){
          $(".menuM").removeClass("opened");
          $("header").removeClass("menu-active");
          $("body").removeClass("stop-scrolling");
          $(".mobile-menu").removeClass("active-cross");
      ...
      $(".contact-close, .close-success").click(function(){
        setTimeout(function(){
          $("section").removeClass("oP")
        },300);
      });

      $(window).scroll(function(){
        if($(".contact-wrap.show").length > 0 && $(window).scrollTop() > 100 && $(window).width() > 1080 ){
          $(".contact-wrap").removeClass("show")
        }
        else if($(".contact-wrap.show").length > 0 && $(window).scrollTop() > $(".contact-wrap").height() && $(window).width() < 1080){
          $(".contact-wrap").removeClass("show");
          $("section").removeClass("oP")
        }
      });
          ...
          fields: {
            ...
            surname: {
              ...
              rules: [
                {
                  type   : 'empty',
                  prompt : 'Lütfen soyadınızı giriniz.'
                }
              ]
            },
            email: {
            ...
            message: {
                ...
                rules: [{
                    type: 'empty',
                    prompt: 'Lütfen mesajınızı giriniz..'
                }]
            },
